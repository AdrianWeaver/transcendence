    ...
    return (
        ...
        < MenuBar />
            ...
            <ul>
                ...
                <li>Whenever you miss the ball, your adversary earns one point. The player who is the first one to earn 13 points wins, and the game stops.</li>
            ...
            <h2>Nevertheless, if you choose the special mode, the game might get a little drunk ^^</h2>
